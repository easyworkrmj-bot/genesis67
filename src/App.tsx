                    ...
                    <thead>
                      <tr className={`${
                        ...
                        {colors[activeColorIdx].tailles.map((sz, idx) => (
                          <th key={idx} className={`border-r min-w-28 p-1.5 ${darkMode ? 'border-white/10' : 'border-slate-700 bg-slate-900/10'}`}>
                            <input
                              type="text"
                              value={sz}
                    ...
                    <tbody className={`divide-y font-mono ${darkMode ? 'divide-white/10' : 'divide-slate-200'}`}>
                      ...
                      <tr className={darkMode ? '' : 'hover:bg-slate-50/50'}>
                        ...
                        {colors[activeColorIdx].tailles.map((sz) => {
                          ...
                          return (
                            <td key={sz} className={`p-1 border-r ${darkMode ? 'border-white/10' : 'border-slate-200'}`} style={remColor ? { backgroundColor: remColor.bg + '1a' } : undefined}>
                              <input
                                type="number"
                                min="0"
                      ...
                      <tr className={darkMode ? '' : 'hover:bg-slate-50/50'}>
                        ...
                        {colors[activeColorIdx].tailles.map((sz) => (
                          <td key={sz} className={`p-1 border-r ${darkMode ? 'border-white/10' : 'border-slate-200'}`}>
                            <input
                              type="number"
                              min="1"
                      ...
                      <tr className={darkMode ? '' : 'hover:bg-slate-50/50'}>
                        ...
                        {colors[activeColorIdx].tailles.map((sz) => {
                          ...
                          return (
                            <td key={sz} className={`p-1.5 border-r ${darkMode ? 'border-white/10' : 'border-slate-200'}`}>
                              <button
                          ...
                          <thead>
                            <tr className={`${
                              ...
                              {activeColorConfig.tailles.map((sz) => (
                                <th key={sz} className={`p-2 border-r font-mono font-black text-xs ${
                                  darkMode ? 'border-white/10 bg-white/5 text-white' : 'border-slate-700 bg-slate-900/10 text-white font-bold'
                                }`}>
                                  {sz}
                                </th>
                              ))}
                              <th className={`p-2 font-mono font-black text-xs ${
                                  darkMode ? 'border-white/10 bg-white/10 text-white' : 'border-slate-700 bg-slate-900/10 text-white font-bold'
                              }`}>
                                TOTALE
                              </th>
                            </tr>
                          ...
                          <tbody className={`divide-y font-mono font-semibold ${darkMode ? 'divide-white/10 text-slate-300' : 'divide-slate-200 text-slate-800'}`}>
                            ...
                            <tr className={darkMode ? 'bg-[#0F0F12] hover:bg-white/5' : 'bg-white hover:bg-slate-50'}>
                              ...
                              {activeColorConfig.tailles.map((sz) => {
                                ...
                                return (
                                  <td key={sz} className={`p-2 border-r font-black text-xs ${darkMode ? 'border-white/10 text-white' : 'border-slate-200 text-slate-800'}`}>
                                    {qTot}
                                  </td>
                                );
                              })}
                            ...
                            <tr className={darkMode ? 'bg-[#0F0F12] hover:bg-white/5' : 'bg-white hover:bg-slate-50'}>
                              ...
                              {activeColorConfig.tailles.map((sz) => {
                                ...
                                return (
                                  <td key={sz} className={`p-2 border-r text-slate-500 dark:text-slate-400 font-medium ${darkMode ? 'border-white/10' : 'border-slate-200'}`}>
                                    {c}
                                  </td>
                                );
                              })}
                            ...
                            <tr className={darkMode ? 'bg-[#0F0F12] hover:bg-white/5' : 'bg-white hover:bg-slate-50'}>
                              ...
                              {activeColorConfig.tailles.map((sz) => {
                                ...
                                const fullCtn = c > 0 ? Math.floor(qTot / c) : 0;
                                return (
                                  <td key={sz} className={`p-2 border-r font-semibold ${darkMode ? 'border-white/10 text-slate-250' : 'border-slate-200 text-slate-700'}`}>
                                    {fullCtn}
                                  </td>
                                );
                              })}
                            ...
                            <tr className={darkMode ? 'bg-[#0F0F12] hover:bg-white/5' : 'bg-white hover:bg-slate-50'}>
                              ...
                              {activeColorConfig.tailles.map((sz) => {
                                ...
                                const fullPcs = fullCtn * c;
                                return (
                                  <td key={sz} className={`p-2 border-r font-medium ${darkMode ? 'border-white/10 text-slate-300' : 'border-slate-200 text-slate-700'}`}>
                                    {fullPcs}
                                  </td>
                                );
                              })}
                            ...
                            <tr className={darkMode ? 'bg-white/5 hover:bg-white/10' : 'bg-amber-500/5 hover:bg-amber-500/10'}>
                              <td className={`py-2.5 px-4 text-left font-sans font-black border-r ${
                                darkMode ? 'border-white/10 bg-[#15151A] text-white' : 'border-slate-200 bg-slate-100/20 text-red-655'
                              }`}>
                                QTY PCS LAST (RESTE)
                              </td>
                              {activeColorConfig.tailles.map((sz) => {
                                ...
                                return (
                                  <td key={sz} className={`p-2 border-r font-mono font-black ${darkMode ? 'border-white/10 text-white' : 'border-slate-200 text-slate-800'}`} style={cellStyle}>
                                    {lastPcs}
                                  </td>
                                );
                              })}
                        ...
                        <div id="color-filter-card" className={`p-4 rounded-xl border print:hidden shadow-sm transition-colors ${
                          ...
                          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={`text-[10px] px-2 py-0.5 rounded-full font-mono text-[#ffffff] ${darkMode ? 'bg-white/10' : 'bg-slate-800'}`}>
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className={`px-2.5 py-1 text-[11px] font-bold font-mono rounded border cursor-pointer transition-all text-[#dad1d1] ${
                                  darkMode ? 'bg-white/5 hover:bg-white/10 border-white/10' : 'bg-slate-100 hover:bg-slate-200 border-slate-200'
                                }`}
                              >
                                TOUTES LES COULEURS
                              </button>
                          ...
                          <table className="w-full text-xs text-center border-collapse">
                            <thead>
                              <tr className={`font-mono font-semibold border-b ${darkMode ? 'bg-white/5 text-slate-300 border-white/10' : 'bg-slate-800 text-white border-slate-700'}`}>
                                ...
                                {summaryUniqueSizes.map(t => <th key={t} className={`border-r ${darkMode ? 'border-white/10' : 'border-slate-700'}`}>{t}</th>)}
                                <th>TOTAL PCS</th>
                              </tr>
                            </thead>
                            <tbody className={`divide-y font-mono font-medium ${darkMode ? 'divide-white/10' : 'divide-slate-200'}`}>
